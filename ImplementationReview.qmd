...
A data-oriented way to think about this may be to figure out the practices that show the least and greatest differences between Credentialed and non-Credentialed schools
```{r}
IRCredential <- IRs |> 
